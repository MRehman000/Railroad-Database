...
class Segments(models.Model):
    ...
    seg_n_end = models.ForeignKey('Stations', models.DO_NOTHING, db_column='seg_n_end')
    seg_s_end = models.ForeignKey('Stations', models.DO_NOTHING, db_column='seg_s_end')
...
class Trains(models.Model):
    ...
    train_start = models.ForeignKey(Stations, models.DO_NOTHING, db_column='train_start')
    train_end = models.ForeignKey(Stations, models.DO_NOTHING, db_column='train_end')
